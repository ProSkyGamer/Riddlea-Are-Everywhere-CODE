...
public class ChangePlayerInterface : MonoBehaviour
{
    ...
    private void Start()
    {
        foreach (PlayerSO playerSO in PlayerChangeController.Instance.GetAllPlayersSO().allPlayersSO)
        {
            ...
            playerCard.GetComponentInChildren<TextMeshProUGUI>().text = 
            ...
            if (!ShopManager.IsCurrentPlayerBought(playerSO) && !PlayerChangeController.
                Instance.GetAlwaysAvailiblePlayers().Contains(playerSO))
